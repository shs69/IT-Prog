...
public class Test_HashTable {
    public static void main(String[] args){
        ...
        phoneBook.put("79103136542", new Contact("Sanya", "sanya@mail,ru", "18 y.o., 6ura40k"));
        phoneBook.put("79103136442", new Contact("Valera", "valera@mail,ru", "18 лет, Пошлый"));
        phoneBook.put("79063139542", new Contact("Kirill", "topMLengineer@mail,ru", "Обучу вашу нейронку. Дорого"));
        phoneBook.put("79153136542", new Contact("Valeria", "wifeKrupoderova@mail,ru", "Могу и лабу сделать, и накормить. По желанию."));
