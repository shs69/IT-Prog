...
public class Parrot extends Animals{
    ...
    public Parrot(String familyAnimal, String name, float weight, String color, String breed,
                  String ownerName, String parrotFather, boolean hungry, boolean sleep){
    ...
    @Override
    public void needEat(){
        System.out.println("Человек, капитан Прайс хочет есть!");
    }
    public void full(){
        System.out.println("Не хочу я есть!");
    }
    ...
    public void noSleep(){
        System.out.println("Никто не спит! Я полон энергии!");
    }
