...
public class Fish extends Animals{
    ...
    public Fish(String familyAnimal, String name, float weight, String color, String breed,
                String ownerName, boolean hungry, String nativeReservoir, boolean isGold) {
